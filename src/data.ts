  ...
  projects: [
    {
      name: "Next-Stop",
      description:
        "A travel planning application that allows users to create personalized itineraries by adding new destinations, editing existing plans, and deleting locations as needed. All trip data is stored persistently, enabling users to manage and update their travel plans seamlessly across sessions.",
      technologies: [
        "React",
        "JavaScript",
        "API",
      ...
      liveLink:
        "https://next-stop-8utb2j3ln-sandyezzat70-6640s-projects.vercel.app/",
      thumbnail: "/NextStop.jpeg",
    },
    {
      name: "Popcorn-Pulse",
      description:
        "A movie discovery platform built to explore the differences between Client-Side Rendering (CSR) and Server-Side Rendering (SSR). Users can browse and search for movies through an external API, while comparing how each rendering approach impacts performance, SEO, and user experience.",
    ...
    },
    {
      ...
      thumbnail: "/OneBasket2.webp",
    },
    {
      name: "Sandy's Portfolio",
      description:
        "A modern portfolio website showcasing my frontend development expertise. Built with React and TypeScript, it features a clean, responsive design with sticky navigation, dark/light mode support, interactive project modals, and smooth animations. Demonstrates best practices in component architecture, accessibility, and user experience design.",
